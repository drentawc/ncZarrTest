...
if __name__ == '__main__':
    ...
    # with fsspec.open('s3://riva-coastwatch/viirs/npp/science/L2/2021/001/V2021001001530_NPP_SCINIR_L2.nc',
    ...
    with fsspec.open('inputs/V2022003_a1_WW00_chlora.nc',
                     mode='rb',
                     default_fill_cache=False) as f:
        store = zarr.DirectoryStore('outputs/test.zarr')
        h5chunks = Hdf5ToZarr(f, store, xarray=True)
        h5chunks.translate()
